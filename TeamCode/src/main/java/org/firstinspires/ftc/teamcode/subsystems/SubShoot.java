...
public class SubShoot implements Subsystem {
    ...
    public Command PIDshot = new RunToVelocity(controlSystem, -1350, 30).requires(this);
    public Command PIDfarShot = new RunToVelocity(controlSystem, -1450, 30).requires(this);
