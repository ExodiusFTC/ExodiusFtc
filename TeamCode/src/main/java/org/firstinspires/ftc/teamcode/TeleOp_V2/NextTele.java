...
//
//    // correct one: public static Pose startingPose = new Pose(136, 8, Math.toRadians(180)); startpose below is just for testing on small field
//    public static Pose startingPose = new Pose(6, 8, Math.toRadians(180));
