...
@Autonomous(name = "LobsterRedAutoFar")
public class LobsterRedAutoFar extends NextFTCOpMode {
    private ArtifactVision artifactVision;
    private LaserSubsystem laser;



    public LobsterRedAutoFar(){
        addComponents(
    ...
    public final Pose startPose = new Pose(93.85, 9, Math.toRadians(90));
    public final Pose firstShot = new Pose(94, 14, Math.toRadians(90));
    public final Pose ThirdStack_PickUP = new Pose(133, 34, Math.toRadians(0));
    public final Pose BackFromThirdStack = new Pose(84, 16, Math.toRadians(0));
    public final Pose HumanPlayer_PickUp = new Pose(137, 9, Math.toRadians(0));
    public final Pose BackFromHumanPlayer = new Pose(84, 12, Math.toRadians(0));
    private final Pose fallback = new Pose(130,40,Math.toRadians(90));
    ...
    public void buildPaths(){
        ...
        chain1 = PedroComponent.follower().pathBuilder()
                .addPath(new BezierCurve(firstShot, new Pose(81, 32), ThirdStack_PickUP))
    ...
    private Command autonomousRoutine(){
        return new SequentialGroup(
                ...
                new WaitUntil(() -> (Math.abs(SubShoot.INSTANCE.getvel() - SubShoot.INSTANCE.getlutVel(startPose.distanceFrom(RedGOAL)))) <= 50),
